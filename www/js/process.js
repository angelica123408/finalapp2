    ...
    <div className="list-group">
     <div className="navbar">
              <div className="navbar-inner">
                <div className="center">Moral Stories For Kids</div>
              </div>
            </div>

    <div className="list-group">
        <li><a href='#' onClick={process.AholeintheFence}>
          <div className="item-content">
            <div className="item-inner">
              <div className="item-title">A hole in the Fence</div>
        ...
        <div className="list-group">
      <ul>
        <li><a href='#' onClick={process.AMerchantandhisDonkey}>
          <div className="item-content">
            <div className="item-inner">
              <div className="item-title">A Merchant and his Donkey</div>
                  <div className="item-after">Details</div>
            </div>
          </div></a>
        </li>
        <li><a href='#' onClick={process.ChangeYourselfandnotTheWorld}>
          <div className="item-content">
            <div className="item-inner">
              <div className="item-title">Change Yourself and not The World</div>
                  <div className="item-after">Details</div>
            </div>
          </div></a>
        </li>
                <li><a href='#' onClick={process.CommonMan}>
          <div className="item-content">
            <div className="item-inner">
              <div className="item-title">Common Man</div>
                  <div className="item-after">Details</div>
            </div>
          </div></a>
        </li>
        <li><a href='#' onClick={process.GoldCoinsandaSelfishMan}>
          <div className="item-content">
            <div className="item-inner">
              <div className="item-title">Gold Coins and a Selfish Man</div>
                  <div className="item-after">Details</div>
            </div>
          </div></a>
        </li>
      ...
      <div className="list-group">
      <ul>
        <li><a href='#' onClick={process.Loveandthetime}>
          <div className="item-content">
            <div className="item-inner">
              <div className="item-title">Love and the time</div>
                  <div className="item-after">Details</div>
            </div>
          </div></a>
        </li>
        <li><a href='#' onClick={process.MoneyCantbuyeverything}>
          <div className="item-content">
            <div className="item-inner">
              <div className="item-title">Money Cant buy everything</div>
                  <div className="item-after">Details</div>
            </div>
          </div></a>
        </li>
        <li><a href='#' onClick={process.MoneyvsFamily}>
          <div className="item-content">
            <div className="item-inner">
              <div className="item-title">Money vs Family</div>
                  <div className="item-after">Details</div>
            </div>
          </div></a>
        </li>
        <li><a href='#' onClick={process.PowerfulPrayers}>
          <div className="item-content">
            <div className="item-inner">
              <div className="item-title">Powerful Prayers</div>
                  <div className="item-after">Details</div>
            </div>
          </div></a>
        </li>
        ...
        <div className="list-group">
      <ul>
        <li><a href='#' onClick={process.RealSolutiontoproblem}>
          <div className="item-content">
            <div className="item-inner">
              <div className="item-title">Real Solution to problem</div>
                  <div className="item-after">Details</div>
            </div>
          </div></a>
        </li>
        <li><a href='#' onClick={process.RealVsFake}>
          <div className="item-content">
            <div className="item-inner">
              <div className="item-title">Real Vs Fake</div>
                  <div className="item-after">Details</div>
            </div>
          </div></a>
        </li>
                <li><a href='#' onClick={process.TheAntandtheDove}>
          <div className="item-content">
            <div className="item-inner">
              <div className="item-title">The Ant and the Dove</div>
                  <div className="item-after">Details</div>
            </div>
          </div></a>
        </li>
                <li><a href='#' onClick={process.TheAntandtheGrasshopper}>
          <div className="item-content">
            <div className="item-inner">
              <div className="item-title">The Ant and the Grasshopper</div>
                  <div className="item-after">Details</div>
            </div>
          </div></a>
        </li>
            ...
            <div className="list-group">
      <ul>
        <li><a href='#' onClick={process.TheLazyJack}>
          <div className="item-content">
            <div className="item-inner">
              <div className="item-title">The Lazy Jack</div>
                  <div className="item-after">Details</div>
            </div>
          </div></a>
        </li>
        ...
        <div className="list-group">
      <ul>
        <li><a href='#' onClick={process.TheCunningFoxandthecleverfork}>
          <div className="item-content">
            <div className="item-inner">
              <div className="item-title">The Cunning Fox and the clever fork</div>
                  <div className="item-after">Details</div>
            </div>
          </div></a>
        </li>
        ...
        <div className="list-group">
      <ul>
        <li><a href='#' onClick={process.TheFaithfuldog}>
          <div className="item-content">
            <div className="item-inner">
              <div className="item-title">The Faithful dog</div>
                  <div className="item-after">Details</div>
            </div>
          </div></a>
        </li>
        ...
        <div className="list-group">
      <ul>
        <li><a href='#' onClick={process.TheFoxandtheGrapes}>
          <div className="item-content">
            <div className="item-inner">
              <div className="item-title">The Fox and the Grapes</div>
                  <div className="item-after">Details</div>
            </div>
          </div></a>
        </li>
     	...
     	<div className="list-group">
      <ul>
        <li><a href='#' onClick={process.TheGooseandthegoldeneggs}>
          <div className="item-content">
            <div className="item-inner">
              <div className="item-title">The Goose and the golden eggs</div>
                  <div className="item-after">Details</div>
            </div>
          </div></a>
        </li>
    	...
    	<div className="list-group">
      <ul>
        <li><a href='#' onClick={process.TheHareandtheTortoise}>
          <div className="item-content">
            <div className="item-inner">
              <div className="item-title">The Hare and the Tortoise</div>
                  <div className="item-after">Details</div>
            </div>
          </div></a>
        </li>
    	...
    	<div className="list-group">
      <ul>
        <li><a href='#' onClick={process.TheLionandtheMouse}>
          <div className="item-content">
            <div className="item-inner">
              <div className="item-title">The Lion and the Mouse</div>
                  <div className="item-after">Details</div>
            </div>
          </div></a>
        </li>
...
<div className="page-content contacts-content">
  <div className="list-block contacts-block">
    <div className="list-group">
     <div className="navbar">
              <div className="navbar-inner">
                <div className="center">A hole in the Fence &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href='#' onClick={process.menu}>back</a></div>
              </div>
            </div>
            <br /><center><img src={"img/img1.jpg"} width={"100%"}/>
     ...
     AMerchantandhisDonkey:function(){
    let content = <div className="page">
    <div className="page-content infinite-scroll infinite-scroll-top">
<div className="page-content contacts-content">
  <div className="list-block contacts-block">
    <div className="list-group">
     <div className="navbar">
              <div className="navbar-inner">
                <div className="center">A Merchant and his Donkey &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href='#' onClick={process.menu}>back</a></div>
              </div>
            </div>
            <br /><center><img src={"img/img2.jpg"} width={"100%"}/>
            <p> One beautiful spring morning, a merchant loaded his donkey with bags of salt to go to the market, in order to sell the salt. The merchant and his donkey were walking along together. They had not walked far when they reached a river on the way.
    ...
    ChangeYourselfandnotTheWorld:function(){
    let content = <div className="page">
    <div className="page-content infinite-scroll infinite-scroll-top">
<div className="page-content contacts-content">
  <div className="list-block contacts-block">
    <div className="list-group">
     <div className="navbar">
              <div className="navbar-inner">
                <div className="center">Change Yourself and not The World&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href='#' onClick={process.menu}>back</a></div>
              </div>
            </div>
            <br /><center><img src={"img/img3.jpg"} width={"100%"}/>
            <p> Long ago, people lived happily under the rule of a king. The people of the kingdom were very happy as they led a very prosperous life with an abundance of wealth and no misfortunes.
...
<div className="page-content contacts-content">
  <div className="list-block contacts-block">
    <div className="list-group">
     <div className="navbar">
              <div className="navbar-inner">
                <div className="center">Common Man &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href='#' onClick={process.menu}>back</a></div>
              </div>
            </div>
            <br /><center><img src={"img/img4.jpg"} width={"100%"}/>
            <p> Raj purchased a few toys from the little boy. He thought about what the boy had said. He realized that he had been wrong in the way he treated his parents. He had learnt a lesson from the small boy. At a very small age, this boy was helping his parents, but Raj, in order to meet the demands of his lavish lifestyle, had neglected his parents.
...
Respect is the foundation of love, and it is our duty to take care of our parents, when we get older and mature.
     ...
     GoldCoinsandaSelfishMan:function(){
    let content = <div className="page">
    <div className="page-content infinite-scroll infinite-scroll-top">
<div className="page-content contacts-content">
  <div className="list-block contacts-block">
    <div className="list-group">
     <div className="navbar">
              <div className="navbar-inner">
                <div className="center">Gold Coins and a Selfish Man&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href='#' onClick={process.menu}>back</a></div>
              </div>
            </div>
            <br /><center><img src={"img/img5.jpg"} width={"100%"}/>
            <p>Sam was a greedy and selfish man. He always desired to have lots and lots of money and never hesitated to cheat others to make money. Also, he never wished to share anything with others. He paid very low wages to his servants.
...
<div className="page-content contacts-content">
  <div className="list-block contacts-block">
    <div className="list-group">
     <div className="navbar">
              <div className="navbar-inner">
                <div className="center">Love and the time&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href='#' onClick={process.menu}>back</a></div>
              </div>
            </div>
            <br /><center><img src={"img/img6.jpg"} width={"100%"}/>
            <p> Once upon a time, there was an island where all the feelings lived: Happiness, Sadness, Knowledge, and all the others, including Love. One day it was announced to the feelings that the island would sink, so all constructed boats and left. Except for Love.
...
Knowledge smiled with deep wisdom and answered, “Because only Time is capable of understanding how valuable Love is.”
     ...
     MoneyCantbuyeverything:function(){
    let content = <div className="page">
    <div className="page-content infinite-scroll infinite-scroll-top">
<div className="page-content contacts-content">
  <div className="list-block contacts-block">
...
<div className="page-content contacts-content">
  <div className="list-block contacts-block">
    <div className="list-group">
     <div className="navbar">
              <div className="navbar-inner">
                <div className="center">Money vs Family &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href='#' onClick={process.menu}>back</a></div>
              </div>
            </div>
            <br /><center><img src={"img/img8.jpg"} width={"100%"}/>
            <p> Rama’s family is very big. Rama is a hard worker and he is the sole bread winner of the family. He has three kids, two sons and a daughter. He lives along with father and mother. Rama used to work too hard to feed his family.
...
<div className="page-content contacts-content">
  <div className="list-block contacts-block">
    <div className="list-group">
     <div className="navbar">
              <div className="navbar-inner">
                <div className="center">Powerful Prayers&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href='#' onClick={process.menu}>back</a></div>
              </div>
            </div>
            <br /><center><img src={"img/img9.jpg"} width={"100%"}/>
            <p> Kim and Ray were very close companions. They were neighbours, classmates at school, and later, colleagues at work.
...
Moral: Selflessness is the highest form of prayer.
     ...
     RealSolutiontoproblem:function(){
    let content = <div className="page">
    <div className="page-content infinite-scroll infinite-scroll-top">
<div className="page-content contacts-content">
  <div className="list-block contacts-block">
    <div className="list-group">
     <div className="navbar">
              <div className="navbar-inner">
                <div className="center">Real Solution to problem &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href='#' onClick={process.menu}>back</a></div>
              </div>
            </div>
            <br /><center><img src={"img/img10.jpg"} width={"100%"}/>
            <p> A group of employees was working in a software company. It was a team of 30 employees. This was a young, energetic and dynamic team with keen enthusiasm and desire to learn and grow. The management decided to teach the employees about finding real solution to the problems.  
...
<div className="page-content contacts-content">
  <div className="list-block contacts-block">
    <div className="list-group">
     <div className="navbar">
              <div className="navbar-inner">
                <div className="center">Real Vs Fake &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href='#' onClick={process.menu}>back</a></div>
              </div>
            </div>
            <br /><center><img src={"img/img11.jpg"} width={"100%"}/>
            <p> Minnu was a sweet, lovable and beautiful girl, aged six years. She was an adorable kid as she always obeyed her elders. Minnu’s parents loved her for her amazing behaviour.
...
<div className="page-content contacts-content">
  <div className="list-block contacts-block">
    <div className="list-group">
     <div className="navbar">
              <div className="navbar-inner">
                <div className="center">The Ant and the Dove &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href='#' onClick={process.menu}>back</a></div>
              </div>
            </div>
            <br /><center><img src={"img/img12.jpg"} width={"100%"}/>
            <p> One hot day, an ant was searching for some water. After walking around for some time, she came to a spring. To reach the spring, she had to climb up a blade of grass. While making her way up, she slipped and fell into the water.
...
. </p></center>
     ...
     TheAntandtheGrasshopper:function(){
    let content = <div className="page">
    <div className="page-content infinite-scroll infinite-scroll-top">
<div className="page-content contacts-content">
  <div className="list-block contacts-block">
    <div className="list-group">
     <div className="navbar">
              <div className="navbar-inner">
                <div className="center">The Ant and the Grasshopper &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href='#' onClick={process.menu}>back</a></div>
              </div>
            </div>
            <br /><center><img src={"img/img13.jpg"} width={"100%"}/>
            <p> "One summer’s day, in a field, a Grasshopper was hopping about, chirping and singing to its heart's content. An Ant passed by, bearing along with great effort an ear of corn he was taking to his nest.
...
Then the Grasshopper knew. MORAL: WORK TODAY AND YOU CAN REAP THE BENEFITS TOMORROW!
...
<div className="page-content contacts-content">
  <div className="list-block contacts-block">
    <div className="list-group">
     <div className="navbar">
              <div className="navbar-inner">
                <div className="center">The Lazy Jack &nbsp;&nbsp;&nbsp;<a href='#' onClick={process.menu}>back</a></div>
              </div>
            </div>
            <br /><center><img src={"img/img14.jpg"} width={"100%"}/>
...
A young girl around 8 years of age who saw Jack carrying the donkey on shoulders started to laugh and she laughed continuously for long time. Her dad, who was the richest person in the town, was so happy and was in tears. He thanked Jack as he made her daughter laugh after 5 years. Jack realized his mistakes and foolishness he done then and before. But at the same time his foolishness made that rich man’s daughter laugh. He took the rich man and his daughter to his home. The rich man offered them work and shelter in his bungalow. From that incident, he tried to do everything properly without any mistakes and foolishness and they lived happily ever after!
     ...
     TheCunningFoxandthecleverfork:function(){
    let content = <div className="page">
    <div className="page-content infinite-scroll infinite-scroll-top">
<div className="page-content contacts-content">
  <div className="list-block contacts-block">
    <div className="list-group">
     <div className="navbar">
              <div className="navbar-inner">
                <div className="center">The Cunning Fox and the clever fork &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href='#' onClick={process.menu}>back</a></div>
              </div>
            </div>
            <br /><center><img src={"img/img15.jpg"} width={"100%"}/>
            <p>Once upon a time, there lived a very cunning and mischievous fox. He used to speak to other animals sweetly and gain their trust, before playing tricks on them.
...
<div className="page-content contacts-content">
  <div className="list-block contacts-block">
    <div className="list-group">
     <div className="navbar">
              <div className="navbar-inner">
                <div className="center">The Fox and the Grapes &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href='#' onClick={process.menu}>back</a></div>
              </div>
            </div>
            <br /><center><img src={"img/17.jpg"} width={"100%"}/>
            <p>One afternoon, a fox was walking through the forest and spotted a bunch of grapes hanging from a lofty branch. Just the thing to quench my thirst, said the fox.
...
MORAL: ITS EASY TO DESPISE WHAT YOU CANNOT HAVE.
  	...
  	TheGooseandthegoldeneggs:function(){
    let content = <div className="page">
    <div className="page-content infinite-scroll infinite-scroll-top">
<div className="page-content contacts-content">
  <div className="list-block contacts-block">
    <div className="list-group">
     <div className="navbar">
              <div className="navbar-inner">
                <div className="center">The Goose and the golden eggs &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href='#' onClick={process.menu}>back</a></div>
              </div>
            </div>
            <br /><center><img src={"img/img18.jpg"} width={"100%"}/>
...
MORAL: THINK BEFORE YOU ACT
  ...
  TheHareandtheTortoise:function(){
    let content = <div className="page">
    <div className="page-content infinite-scroll infinite-scroll-top">
<div className="page-content contacts-content">
  <div className="list-block contacts-block">
    <div className="list-group">
     <div className="navbar">
            ...
            <br /><center><img src={"img/img19.jpg"} width={"100%"}/>
            <p>There once was a speedy Hare who bragged about how fast he could run. Tired of hearing him boast, the Tortoise challenged him to a race. All the animals in the forest gathered to watch.
...
<div className="page-content contacts-content">
  <div className="list-block contacts-block">
    <div className="list-group">
     <div className="navbar">
              <div className="navbar-inner">
                <div className="center">The Lion and the Mouse &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href='#' onClick={process.menu}>back</a></div>
              </div>
            </div>
            <br /><center><img src={"img/img20.jpg"} width={"100%"}/>
...
Just then the little mouse happened to pass by. On seeing the lions plight, he ran up to him and gnawed away the ropes that bound him, the king of the jungle.
Was I not right? said the little mouse, very happy to help the lion.
MORAL: Small acts of kindness will be rewarded great.
 </p></center>
  ...
  loading:function(){
    let content = <div>
          <img src={"img/Penguins.jpg"} width={"100%"}/>
    </div>;
    ReactDOM.render(content,document.getElementById('root'));
  }
}
